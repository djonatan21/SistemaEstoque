...
begin
  DmMenuPrincipal.SQLConfigSistema.Post;
end;

procedure TFormConfig.EditarDados;
begin
  try
    DmMenuPrincipal.SQLConfigSistema.Edit;
  except
    ShowMessage('Erro, Não Foi Pocivel Editar Registro!!');
  end;
end;
...
begin
  DmMenuPrincipal.SQLConfigSistema.Insert;
end;
...
begin
  try
    DmMenuPrincipal.SQLConfigSistema.Post;
    DmMenuPrincipal.SQLConfigSistema.ApplyUpdates(0);
  except
